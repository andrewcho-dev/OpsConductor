"""
Event publishing integration for Jobs Service
"""
...
async def publish_job_event(event_type, data, correlation_id=None, user_id=None):
    """Helper function to publish job-related events"""
    if event_publisher:
        try:
            from opsconductor_shared.models.base import ServiceType
            return await event_publisher.publish_event(
                event_type=event_type,
                service_name=ServiceType.JOBS_SERVICE,
                data=data,

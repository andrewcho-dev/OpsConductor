"""
Event publishing integration for User Service
"""
...
async def publish_user_event(event_type, data, correlation_id=None, user_id=None):
    """Helper function to publish user-related events"""
    if event_publisher:
        try:

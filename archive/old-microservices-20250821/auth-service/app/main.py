...
Independent microservice for authentication and authorization in OpsConductor
"""
...
app = FastAPI(
    title="Auth Service",
    description="Independent microservice for authentication and authorization in OpsConductor",
    version="1.0.0",

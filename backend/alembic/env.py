...
def get_url():
    return os.getenv(
        "DATABASE_URL",
        "postgresql://opsconductor:opsconductor_secure_password_2024@postgres:5432/opsconductor_dev"
    )
...
import app.models.universal_target_models
import app.models.system_models
import app.models.notification_models
